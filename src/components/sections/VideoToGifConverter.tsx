      ...
      <div className="relative max-w-5xl mx-auto w-full">
        ...
        >
          <div className="inline-flex items-center whitespace-nowrap gap-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-1.5 mb-3 border border-gray-200 dark:border-gray-700">
            <FiFilm className="h-4 w-4 text-indigo-600" />
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8">
              {[
                ...
                <div key={step} className="flex items-center gap-3 sm:gap-4">
                  <div className={`flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 transition-all duration-300 ${conversionStep === step
                  ...
                  <span className={`text-sm sm:text-base font-medium ${conversionStep === step || (conversionStep === 'complete' && step === 'complete')
                  ...
                  {index < 2 && (
                    <div className={`w-6 sm:w-8 h-0.5 mx-2 sm:mx-4 ${index === 0 || conversionStep === 'convert' || conversionStep === 'complete'
                        ? 'bg-indigo-600'
            ...
            <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-gray-200 dark:border-gray-700/50 p-8 h-full inline-flex items-center whitespace-nowrap justify-center min-h-[400px]">
              {gifURL ? (
                ...
                <div className="text-center text-gray-400">
                  ...
                  <p className="text-lg">{t('previewPlaceholder')}</p>
                </div>
              )}
            </div>
          </motion.div>
