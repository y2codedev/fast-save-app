...
import { FiUpload, FiImage, FiDownload, FiZap, FiSave } from 'react-icons/fi'
                            ...
                            {original && (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-5">
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">{t('targetW')}</label>
                                            <input 
                                                type="number" 
                                                value={targetWidth}
                                        ...
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">{t('targetH')}</label>
                                            <input 
                                                type="number" 
                                                value={targetHeight}
                                    ...
                                    <Button
                                        ...
                                        label={compressed ? t('recompressBtn') : t('compressBtn')}
                                ...
                                {loading ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400 text-lg font-medium">
                                            {original ? t('compressingTitle') : t('uploadToStart')}
                                        </p>
                                        <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">
                                            {original ? t('willAppearHere') : t('willAppearHere')}
                                        </p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                        ...
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 dark:border-gray-700/50">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="text-center">
                                    <h4 className="font-semibold text-red-600 dark:text-red-400 mb-4">{t('original')}</h4>
                                ...
                                <div className="text-center">
                                    <h4 className="font-semibold text-green-600 dark:text-green-400 mb-4">{t('compressed')}</h4>
            ...
            >
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 dark:border-gray-700/50">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                        <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">{t('tagNoLoss')}</span>
                        <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">{t('tagFast')}</span>
                        <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">{t('tagFree')}</span>
                        <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">{t('tagAllFormats')}</span>
                    </div>
                </div>
            </motion.div>
        </div>
