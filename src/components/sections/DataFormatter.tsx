  ...
  return (
    <div className="mx-auto max-w-[1500px] px-3 sm:px-6 lg:px-8">
      ...
      <div className="text-center space-y-3 mb-8">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800 text-indigo-700 dark:text-indigo-300 text-xs font-semibold uppercase tracking-wider shadow-sm">
        ...
        <div className="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-4 pb-4 border-b border-gray-100 dark:border-gray-800/80">
          ...
          <div className="flex flex-wrap items-center justify-start xl:justify-end gap-2 sm:gap-2.5">
            ...
            <button
              ...
              className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3.5 py-2 sm:py-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700/80 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-200 font-semibold text-sm transition-all"
            >
            ...
            <button
              ...
              className="flex-initial flex items-center justify-center gap-1.5 px-3.5 py-2 sm:py-2.5 rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/60 hover:bg-red-100 dark:hover:bg-red-900/50 text-red-600 dark:text-red-400 font-semibold text-sm transition-all"
              title="Clear text"
            >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 text-sm">
          ...
          <div className="flex flex-wrap items-center gap-2 bg-gray-50 dark:bg-gray-800/70 p-2 rounded-xl border border-gray-200/80 dark:border-gray-700/70 w-full sm:w-auto">
            ...
            <button
              ...
              className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-4 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs sm:text-sm shadow transition-all"
            >
          ...
          {/* View Mode Toggle */}
          <div className="flex items-center gap-1.5 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl self-end sm:self-auto w-full sm:w-auto justify-end">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-3 bg-gray-950 border-b border-gray-800 text-gray-300 text-xs font-semibold min-h-[48px]">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 ml-auto">
              <button
                onClick={handleCopy}
                disabled={!output}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-gray-800 hover:bg-gray-700 border border-gray-700 text-gray-200 text-xs font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              >
              ...
              <button
                ...
                disabled={!output}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
