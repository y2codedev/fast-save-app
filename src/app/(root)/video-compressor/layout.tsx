...
export const generateMetadata = (): Metadata => {
    ...
    return {
        metadataBase: new URL("https://fast-save.vercel.app/video-compressor"),
        title,
        description,
        keywords,
        authors: [{ name: "FastSave", url: "https://fast-save.vercel.app/video-compressor" }],
        publisher: "FastSave",
        creator: "FastSave",
        robots: {
            index: true,
        ...
        alternates: {
            canonical: "https://fast-save.vercel.app/video-compressor",
        },
        openGraph: {
            title,
            description,
            type: "website",
            url: "https://fast-save.vercel.app/video-compressor",
            siteName: "FastSave",
            locale: "en_IN",
            images: [
                {
