...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Tar To Zip', href: '/tar-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['tar-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/tar-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
