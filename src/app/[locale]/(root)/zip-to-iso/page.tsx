...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Iso', href: '/zip-to-iso' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-iso'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-iso" locale={locale} breadcrumb={breadcrumbItems} />
