...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Rar To Zip', href: '/rar-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['rar-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/rar-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
