...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Create Zip', href: '/create-zip' },
  ];
  const relatedTools = RELATED_TOOLS['create-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/create-zip" locale={locale} breadcrumb={breadcrumbItems} />
