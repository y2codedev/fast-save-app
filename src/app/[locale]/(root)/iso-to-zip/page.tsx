...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Iso To Zip', href: '/iso-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['iso-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/iso-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
