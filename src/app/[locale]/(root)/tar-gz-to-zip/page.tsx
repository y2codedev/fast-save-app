...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Tar Gz To Zip', href: '/tar-gz-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['tar-gz-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/tar-gz-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
