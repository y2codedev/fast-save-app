...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Gz To Zip', href: '/gz-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['gz-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/gz-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
