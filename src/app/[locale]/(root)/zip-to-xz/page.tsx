...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Xz', href: '/zip-to-xz' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-xz'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-xz" locale={locale} breadcrumb={breadcrumbItems} />
