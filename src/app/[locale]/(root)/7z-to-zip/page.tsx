...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: '7z To Zip', href: '/7z-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['7z-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/7z-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
