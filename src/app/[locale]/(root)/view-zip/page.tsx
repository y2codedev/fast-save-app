...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'View Zip', href: '/view-zip' },
  ];
  const relatedTools = RELATED_TOOLS['view-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/view-zip" locale={locale} breadcrumb={breadcrumbItems} />
