...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Tar Xz To Zip', href: '/tar-xz-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['tar-xz-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/tar-xz-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
