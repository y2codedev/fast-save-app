...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Tar', href: '/zip-to-tar' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-tar'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-tar" locale={locale} breadcrumb={breadcrumbItems} />
