...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Bz2', href: '/zip-to-bz2' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-bz2'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-bz2" locale={locale} breadcrumb={breadcrumbItems} />
