...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Tar Gz', href: '/zip-to-tar-gz' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-tar-gz'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-tar-gz" locale={locale} breadcrumb={breadcrumbItems} />
