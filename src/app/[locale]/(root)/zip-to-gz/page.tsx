...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Gz', href: '/zip-to-gz' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-gz'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-gz" locale={locale} breadcrumb={breadcrumbItems} />
