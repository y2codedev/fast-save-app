...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Rar', href: '/zip-to-rar' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-rar'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-rar" locale={locale} breadcrumb={breadcrumbItems} />
