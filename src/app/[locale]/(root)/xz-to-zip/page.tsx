...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Xz To Zip', href: '/xz-to-zip' },
  ];
  const relatedTools = RELATED_TOOLS['xz-to-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/xz-to-zip" locale={locale} breadcrumb={breadcrumbItems} />
