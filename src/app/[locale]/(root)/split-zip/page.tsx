...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Split Zip', href: '/split-zip' },
  ];
  const relatedTools = RELATED_TOOLS['split-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/split-zip" locale={locale} breadcrumb={breadcrumbItems} />
