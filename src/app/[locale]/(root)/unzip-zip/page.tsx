...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Unzip Zip', href: '/unzip-zip' },
  ];
  const relatedTools = RELATED_TOOLS['unzip-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/unzip-zip" locale={locale} breadcrumb={breadcrumbItems} />
