...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Tar Bz2', href: '/zip-to-tar-bz2' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-tar-bz2'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-tar-bz2" locale={locale} breadcrumb={breadcrumbItems} />
