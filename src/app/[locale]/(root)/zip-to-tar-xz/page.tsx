...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Zip To Tar Xz', href: '/zip-to-tar-xz' },
  ];
  const relatedTools = RELATED_TOOLS['zip-to-tar-xz'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/zip-to-tar-xz" locale={locale} breadcrumb={breadcrumbItems} />
