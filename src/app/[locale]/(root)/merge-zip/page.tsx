...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Merge Zip', href: '/merge-zip' },
  ];
  const relatedTools = RELATED_TOOLS['merge-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/merge-zip" locale={locale} breadcrumb={breadcrumbItems} />
