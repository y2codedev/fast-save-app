...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Protect Zip', href: '/protect-zip' },
  ];
  const relatedTools = RELATED_TOOLS['protect-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/protect-zip" locale={locale} breadcrumb={breadcrumbItems} />
