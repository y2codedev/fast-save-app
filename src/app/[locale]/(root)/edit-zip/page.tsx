...
const howToSteps = [
  ...
  const breadcrumbItems = [
    { name: 'Home', href: '/' },
    { name: 'Edit Zip', href: '/edit-zip' },
  ];
  const relatedTools = RELATED_TOOLS['edit-zip'] || [];
  ...
  return (
    <>
      ...
      <FAQSchema faqs={faqs} />
      <WebPageSchema title={title} description={description} path="/edit-zip" locale={locale} breadcrumb={breadcrumbItems} />
